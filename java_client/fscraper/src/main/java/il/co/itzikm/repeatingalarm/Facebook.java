...
public    class Facebook  {
    ...
    public Map<String, String> getFacebookFriends() throws InterruptedException {
        ...
        final GraphRequest graphRequest = new GraphRequest(AccessToken.getCurrentAccessToken(), "/"+AccessToken.getCurrentAccessToken().getUserId()+"/friends", null, HttpMethod.GET, gCallback);
